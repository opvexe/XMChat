...
- (void)initSubViews
{
    ...
    [_sendBtn setTitleColor:UIColorFromRGB(0x424242) forState:UIControlStateNormal];
    ...
    [_setBtn setTitleColor:UIColorFromRGB(0x424242) forState:UIControlStateNormal];
    _setBtn.hidden = YES;
